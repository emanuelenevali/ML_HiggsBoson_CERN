...
This increases the gap between the categories, and makes them more detectable by the model. \\
\vspace{-0.8cm}\\
...
In order to ensure a better functioning of our algorithms, we decided to standardize the data by subtracting from each feature its mean and dividing by its standard deviation: $Z=\frac{X-\mu}{\sigma}$. The same process was applied both to the train set and to the test set, using on the latter $\mu$ and $\sigma$ of the former.\\
\vspace{-0.8cm}\\
...
In addition, we decided to add for each couple of features a new feature with their product. This last operation improved significantly the accuracy of the model.\\
...
\hline
Method & Subset 1 & Subset 2 & Subset 3 & Subset 4 & Average\\
\hline
Gradient Descent & 70.7\% & 65.4\% & 67.9\% & 68.3\% & 68.2\%\\
Stochastic Gradient Descent & 69.8\% & 66.6\% & 67.5\% & 68.5\% & 68.3\%\\
Least squares & 84.6\% & 81.4\% & 84.6\% & 84.2\% & 83.6\%\\
...
0.837, was obtained with a Ridge Regression.\\
